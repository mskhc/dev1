...
{{< note >}}
Хоча каскадне видалення видаляє StatefulSet разом з його Podʼами, каскад **не** видаляє headless Service, пов'язаний з StatefulSet. Ви повинні видалити Service `nginx` вручну.
{{< /note >}}
