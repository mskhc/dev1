...
Ви можете використати [Готовність до планування подів](/docs/concepts/scheduling-eviction/pod-scheduling-readiness/) щоб затримати планування для Pod, доки не буде видалено всі його _scheduling gates_. Наприклад, ви можете визначити набір Pod'ів, але запустити планування лише після того, як всі Pod'и будуть створені.
