...
{{< note >}}
Ви можете налаштувати ліміт затримки для кожного індексу для завдання з [індексацією](#completion-mode), якщо у вас увімкнено [функціональну можливість](/uk/docs/reference/command-line-tools-reference/feature-gates/) `JobBackoffLimitPerIndex` в вашому кластері.
{{< /note >}}
...
{{< note >}}
Ви можете налаштувати політику успіху лише для Індексованого Завдання, якщо у вас увімкнено [функціональну можливість](/uk/docs/reference/command-line-tools-reference/feature-gates/) `JobSuccessPolicy` у вашому кластері.
{{< /note >}}
...
{{< note >}}
Ви можете встановити `podReplacementPolicy` для Завдань тільки у випадку, якщо увімкнуто [функціональну можливість](/uk/docs/reference/command-line-tools-reference/feature-gates/) `JobPodReplacementPolicy` (стандартно увімкнено).
{{< /note >}}
...
{{< note >}}
Ви можете встановити поле `managedBy` для Job лише в разі увімкнення [функціональної можливості](/uk/docs/reference/command-line-tools-reference/feature-gates/) `JobManagedBy` (типово вимкнено).
{{< /note >}}
