...
|    Оператор    |    Поведінка    |
| :------------: | :-------------: |
| `Gt` | Надане значення буде розбиратися як ціле число, і це ціле число менше, ніж ціле число, яке є результатом розбору значення мітки, названої цим селектором |
| `Lt` | Надане значення буде розбиратися як ціле число, і це ціле число більше, ніж ціле число, яке є результатом розбору значення мітки, названої цим селектором |
