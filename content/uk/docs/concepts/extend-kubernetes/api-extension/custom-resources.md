...
| Функція | Опис |
| ------- | ---- |
| CRUD | Нові кінцеві точки підтримують CRUD базові операції через HTTP та `kubectl` |
| Watch | Нові кінцеві точки підтримують операції Watch Kubernetes через HTTP |
...
| json-patch | Нові кінцеві точки підтримують PATCH з `Content-Type: application/json-patch+json` |
| merge-patch | Нові кінцеві точки підтримують PATCH з `Content-Type: application/merge-patch+json` |
| HTTPS | Нові кінцеві точки використовують HTTPS |
