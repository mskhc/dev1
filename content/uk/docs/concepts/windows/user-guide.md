...
{{< note >}}
Якщо ви використовуєте версію Kubernetes старішу за 1.24, вам може знадобитися увімкнути [feature gate](/uk/docs/reference/command-line-tools-reference/feature-gates/) `IdentifyPodOS`, щоб мати можливість встановлювати значення для `.spec.pod.os`.
{{< /note >}}
