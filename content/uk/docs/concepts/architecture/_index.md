...
{{< figure src="/images/docs/kubernetes-cluster-architecture.svg" alt="Панель управління (kube-apiserver, etcd, kube-controller-manager, kube-scheduler) та кілька вузлів. Кожен вузол запускає kubelet та kube-proxy." title="Компоненти кластера Kubernetes" caption="**Примітка:** Ця діаграма представляє приклад референтної архітектури для кластера Kubernetes. Фактичний розподіл компонентів може варіюватися залежно від специфічних налаштувань та вимог кластера." class="diagram-large" >}}
