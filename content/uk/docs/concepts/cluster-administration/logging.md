...
Kubelet завжди направляє систему управління контейнерами на запис логів у теці всередині `/var/log/pods`.
...
Проте, kubelet завжди скеровує систему управління контейнерами на запис логів у теці всередині `C:\var\log\pods`.
