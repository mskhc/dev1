...
| -------------------------------------------|-------------------------------|-------------------------------------------------------------|
| Об'єднати stderr і stdout, записати у stdout| `2>&1`                        | `kube-log-runner` (типова поведінка)                        |
