...
Щоб дізнатись, як застосувати seccomp в Kubernetes, див. [Обмеження системних викликів контейнера за допомогою seccomp](/docs/tutorials/security/seccomp/).
