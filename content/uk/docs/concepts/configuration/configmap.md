...
Назва ConfigMap повинна бути дійсним [піддоменом DNS](/uk/docs/concepts/overview/working-with-objects/names#dns-subdomain-names).
...
- Прочитайте про [Налаштування Podʼа для використання ConfigMap](/uk/docs/tasks/configure-pod-container/configure-pod-configmap/).
- Дізнайтеся про [зміну ConfigMap (або будь-якого іншого обʼєкту Kubernetes)](/uk/docs/tasks/manage-kubernetes-objects/update-api-object-kubectl-patch/)
