...
- **capacity** (map[string]<a href="{{< ref "../common-definitions/quantity#Quantity" >}}">Quantity</a>)
  ...
  Capacity представляє загальні ресурси вузла. Докладніше: [https://kubernetes.io/docs/concepts/storage/persistent-volumes#capacity](/uk/docs/concepts/storage/persistent-volumes#capacity)
