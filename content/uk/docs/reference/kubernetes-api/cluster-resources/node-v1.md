...
- **capacity** (map[string]<a href="{{< ref "../common-definitions/quantity#Quantity" >}}">Quantity</a>)
  ...
  Capacity представляє загальні ресурси вузла. Докладніше: [https://kubernetes.io/docs/concepts/storage/persistent-volumes#capacity](/docs/concepts/storage/persistent-volumes#capacity)

- **conditions** ([]NodeCondition)

  *Patch strategy: merge on key `type`*

  Conditions — це масив поточних спостережуваних станів вузла. Докладніше: [https://kubernetes.io/docs/concepts/nodes/node/#condition](/docs/concepts/nodes/node/#condition)
...
- **nodeInfo** (NodeSystemInfo)
  ...
  Набір id/uuid для унікальної ідентифікації вузла. Докладніше: [https://kubernetes.io/docs/concepts/nodes/node/#info](/docs/concepts/nodes/node/#info)
  ...
  *NodeSystemInfo є набором id/uuid для унікальної ідентифікації вузла.*
  ...
  - **nodeInfo.kubeProxyVersion** (string), обовʼязково
    ...
    Версія KubeProxy, повідомлена вузлом.
...
### `delete` вилучення Node {#delete-delete-a-node}
...
### `deletecollection` вилучення колекції Node {#deletecollection-delete-collection-of-node}
