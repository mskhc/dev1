  ...
  *ServicePort містить інформацію про порт Service.*
  ...
  - **ports.appProtocol** (string)
    ...
    - Протоколи з префіксами, визначеними Kubernetes:
      ...
      - ʼkubernetes.io/h2cʼ — HTTP/2 без шифрування, як описано в <https://www.rfc-editor.org/rfc/rfc7540>
      - ʼkubernetes.io/wsʼ — WebSocket без шифрування, як описано в <https://www.rfc-editor.org/rfc/rfc6455>
      - ʼkubernetes.io/wssʼ —  WebSocket з TLS, як описано в <https://www.rfc-editor.org/rfc/rfc6455>
