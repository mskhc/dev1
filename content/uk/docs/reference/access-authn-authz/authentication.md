...
6. Перевіряє, чи не минув термін дії `id_token`.
    1. Виконує перевірку вимог та/або користувача, якщо з `AuthenticationConfiguration` налаштовані вирази CEL.
