...
іла)</td>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>v1beta2 застаріла, "необхідна дія" інформація про випуск</li>
        </ul>
      </td>
    </tr>
    <tr>
...
2. Додає `"k8s.io/deprecated":"true"` анотацію до [події аудиту](/docs/tasks/debug/debug-cluster/audit/), зареєстрованої для запиту.
