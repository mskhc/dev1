...
Kubernetes підтримує співпрацю кількох аплікаторів для керування полями одного [обʼєкта](/uk/docs/concepts/overview/working-with-objects/).
...
Деталі управління полями зберігаються в полі `managedFields`, яке є частиною [`metadata`](/uk/docs/reference/kubernetes-api/common-definitions/object-meta/) обʼєкта.
...
Формат `managedFields` описаний у [довіднику API Kubernetes](/uk/docs/reference/kubernetes-api/common-definitions/object-meta/#System).
...
Ви можете прочитати про `managedFields` у довіднику API Kubernetes для верхнього рівня поля [`metadata`](/uk/docs/reference/kubernetes-api/common-definitions/object-meta/).
