...
Подібно до команди [kubeadm init phase](/uk/docs/reference/setup-tools/kubeadm/kubeadm-init/#init-phases), команда `kubeadm join phase` дозволяє пропустити список фаз, використовуючи прапорець `--skip-phases`.
