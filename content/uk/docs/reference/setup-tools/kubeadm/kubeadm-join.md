...
Для отримання додаткової інформації щодо полів та використання конфігурації ви можете перейти до нашого [довідника API](/docs/reference/config-api/kubeadm-config.v1beta3/).
