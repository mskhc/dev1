...
- **Вимога до процесора (ядра)** та **Вимога до пам'яті (MiB)**: Ви можете вказати мінімальні [обмеження ресурсів](/docs/tasks/administer-cluster/manage-resources/memory-default-namespace/) для контейнера. Стандартно Podʼи працюють без обмежень на процесор і памʼять.
...
Dashboard показує більшість типів об'єктів Kubernetes та групує їх у кілька категорій меню.
