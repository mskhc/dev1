...
Тут поле `foo` містить повний об'єкт, наприклад:
...
Помилки будуть генеруватися при записі CRD, якщо вузол схеми містить правило переходу, яке ніколи не може бути застосоване, наприклад "_path_: правило оновлення _rule_ не може бути встановлене на схему, оскільки схема або її батьківська схема не придатні до злиття".
