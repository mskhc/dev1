...
Авторизація в Kubernetes має високий рівень, спрямований на грубі дії з ресурсами. Більш потужні елементи керування існують як **політики** для обмеження за випадком використання того, як ці об'єкти діють на кластер, себе та інші ресурси.
