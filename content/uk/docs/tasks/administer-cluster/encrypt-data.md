...
{{< caution >}}
**ВАЖЛИВО:** Для конфігурацій високої доступності (з двома або більше вузлами панелі управління), конфігураційний файл шифрування повинен бути однаковим! В іншому випадку компонент `kube-apiserver` не може розшифрувати дані, збережені в etcd.
{{< /caution >}}
...
{{< caution >}}
Якщо будь-який ресурс не може бути прочитаний через конфігурацію шифрування (через зміну ключів), єдиним виходом буде видалити цей ключ безпосередньо з підтримуваного etcd. Виклики, які намагаються прочитати цей ресурс, завершаться невдачею, поки він не буде видалений або надано дійсний ключ для розшифрування.
{{< /caution >}}
