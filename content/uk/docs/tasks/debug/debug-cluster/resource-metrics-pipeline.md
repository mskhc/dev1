...
* [kubelet](/docs/concepts/overview/components/#kubelet): Агент вузла для управління ресурсами контейнера. Метрики ресурсів доступні за допомогою точок доступу API kubelet `/metrics/resource` та `/stats`.
