...
{{< note >}}
Конфігурація [події аудиту](/uk/docs/reference/config-api/apiserver-audit.v1/#audit-k8s-io-v1-Event) відрізняється від обʼєкта API [Event](/docs/reference/generated/kubernetes-api/{{< param "version" >}}/#event-v1-core).
{{< /note >}}
