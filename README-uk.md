...
Цей репозиторій містить матеріали потрібні для побудови [вебсайту Kubernetes та документації](https://kubernetes.io/). Ми щасливі, що ви хочете зробити свій внесок!
...
Сайт Kubernetes використовує [тему Hugo Docsy](https://github.com/google/docsy#readme). Навіть якщо ви плануєте запускати вебсайт в контейнері, ми настійливо рекомендуємо встановити субмодулі та інші залежності зробивши наступне:
...
Відкрийте у себе в оглядачі адресу <http://localhost:1313> для перегляду локального вебсайту. В міру того, як ви вноситимете зміни в сирці, Hugo оновлюватиме вебсайт та перезавантажуватиме сторінку в оглядачі.
